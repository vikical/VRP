...
def test_swap_node_5_and_2():
    ...
    result=SwapCustomers(solution=None).swap_nodes(route=route,index_node1=5, index_node2=2)
...
def test_swap_node_1_and_1():
    ...
    result=SwapCustomers(solution=None).swap_nodes(route=route,index_node1=1, index_node2=1)
...
def test_swap_node_1st_and_last():
    ...
    result=SwapCustomers(solution=None).swap_nodes(route=route,index_node1=0, index_node2=7)

...
class MoveCustomer(Neighborhood):
    ...
    def get_neighbor(self,solution:Solution)->Solution:
        ...
        node_index_in1=self.__get_node_index_from_route(solution.vehicle_routes[veh1])
        node_index_in2=self.__get_node_index_from_route(solution.vehicle_routes[veh2])
    ...
    def __get_node_index_from_route(self,route:np.ndarray)->int:
        """
